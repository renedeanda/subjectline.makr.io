        ...
        <div className="p-6">
          <div className="mb-6 relative">
            <input
              ...
              className="w-full p-3 sm:p-4 pr-12 text-base sm:text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 transition duration-300 text-gray-700 dark:text-gray-700"
            ...
            <div className="mt-8 p-4 sm:p-6 bg-gray-50 rounded-xl shadow-inner animate-fade-in">
              ...
              {analysis.score < 70 && (
                <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-700">
